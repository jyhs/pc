                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th>积分</th>
                                <th>状态</th>
                                <th class="action-th" v-if="currentUser.type==='yhgly'">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="item in userList" :key="item.id">
                                ...
                                <td align="center" v-if="currentUser.type==='yhgly'">
                                    <el-button
                                            title="编辑"
                                            type="primary"
                                            size="small"
                                            icon="edit"
                                            @click="handleActions(item, 'userEdit')"
                                            v-if="item.status===1">
                                    </el-button>
                                    <el-button
                                            title="修改密码"
                                            ...
                                            size="small"
                                            icon="coral-edit"
                                            @click="handleActions(item, 'userRePass')"
                                            v-if="item.status===1">
                                    </el-button>
                                    <el-button
                                            title="删除"
                                    ...
                                    <el-button
                                            ...
                                            size="small"
                                            icon="caret-top"
                                            @click="handleActions(item, 'recover')"
                                            v-if="item.status===0">
                                    </el-button>
                                    <el-button
                                            title="订单"
                                            ...
                                            size="small"
                                            icon="coral-list"
                                            @click="handleActions(item, 'cartList')">
                                    </el-button>
                                </td>
                            </tr>
                            </tbody>
